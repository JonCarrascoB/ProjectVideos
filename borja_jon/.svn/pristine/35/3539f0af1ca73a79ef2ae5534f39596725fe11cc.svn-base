...
public class LikeDAO {
	...
	private static final String SQL_INSERT_LIKE = "INSERT INTO likes (usuario_id, video_id) VALUES (?,?);";;
	...
	public boolean insertLike(int usuarioId, int videoId) {
		boolean resultado = false;
		

		try (Connection con = ConnectionManager.getConnection(); 
				PreparedStatement pst = con.prepareStatement(SQL_INSERT_LIKE)) {
