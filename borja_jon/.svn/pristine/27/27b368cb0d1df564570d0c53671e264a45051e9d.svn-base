		...
		<div class="col">
			...
			<form action="backoffice/rol" method="post" class="mb-2">
				...
				<div class="form-group">	
					...
					<input type="text" name="id" value="${rolEditar.id}" readonly class="form-control">
				</div>
				
				<div class="form-group">
					<label for="nombre">Nombre:</label>
					<input type="text" name="nombre" value="${rolEditar.nombre}"
				...
				<input type="submit" value="${(rolEditar.id != -1)?'Modificar':'Crear'}" class="btn btn-outline-primary  btn-block">
			
			</form>
			
			<c:if test="${rolEditar.id != -1}">
				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
			        	...
			        	<form action="backoffice/rol" method="post">	
							...
							<input type="hidden" name="id" value="${rolEditar.id}" readonly>			
