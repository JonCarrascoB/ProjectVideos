		...
		<div class="col">
			...
			<form action="videos" method="post" class="mb-2">
				...
				<div class="form-group">	
					<label for="id" ${(sessionScope.usuario.rol.id == 1)?"":"hidden"}>Id:</label>
					<input type="text" name="id" value="${video.id}" readonly 	${(sessionScope.usuario.rol.id == 1)?"":"hidden"}  class="form-control">
				</div>
