		...
		<div class="col">
			...
			<form action="backoffice/categoria" method="post" class="mb-2">
				...
				<div class="form-group">	
					...
					<input type="text" name="id" value="${categoriaEditar.id}" readonly class="form-control">
				</div>
				
				<div class="form-group">
					<label for="nombre">Nombre:</label>
					<input type="text" name="nombre" value="${categoriaEditar.nombre}"
				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
			        	...
			        	<form action="backoffice/categoria" method="post">	
							...
							<input type="hidden" name="id" value="${categoriaEditar.id}" readonly>			
